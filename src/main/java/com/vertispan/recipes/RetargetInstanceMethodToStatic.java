 ...
 * parameter to the newly targeted static method. Handy to rewrite some instances methods from within
 * the library to static methods written specifically for GWT rather than add more super source.
 */
public class RetargetInstanceMethodToStatic extends Recipe {
    ...
    public String getDisplayName() {
        return "Retarget an instance method to a static method";
    }

    @NlsRewrite.Description
    @Override
    public String getDescription() {
        return "Makes \"this\" the first argument of the method call, and retargets the given method. This is useful where the library doesn't own the class and a method isn't compatible but can be retargetted to something else.";
    }
