...
public class RemoveField extends Recipe {
    ...
    public String getDisplayName() {
        return "Removes a field from a class";
    }

    @NlsRewrite.Description
    @Override
    public String getDescription() {
        return "Removes a field from a class, if it exists. This is useful for cleaning up unusable members that should already have all references to them removed.";
    }
