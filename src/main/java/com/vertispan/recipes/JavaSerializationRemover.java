...
public class JavaSerializationRemover extends Recipe {
    ...
    public String getDisplayName() {
        return "Java Serialization Remover";
    }

    @NlsRewrite.Description
    @Override
    public String getDescription() {
        return "Removes references to ObjectInputStream/ObjectOutputStream by taking out readResolve/writeReplace/etc methods from all classes.";
    }
